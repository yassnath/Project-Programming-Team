...
function dmt(dhm) {
  ...
  for (let i = 0; i < dhm.length; i++) {
    myd += `<li>${dhm[i].jeneng}: Rp ${dhm[i].h}</li>`;
    t += dhm[i].h;
  }
  let pothar = 0.1 * t;
  let bt = t - pothar;
  ...
  document.getElementById("fo3").innerHTML = "Rp " + pothar;
...
function dttl(jenis, rego) {
  ...
  let ph = 0.1 * fmbayar;
  let tmbayar = fmbayar - ph;

  document.getElementById("fa1").innerHTML = "Rp " + fmbayar;
  document.getElementById("fa2").innerHTML = "Rp " + ph;
...
// function 1
function cttl(lhm) {
  const lhm_1 = parseInt(lhm[0]);
  const lhm_2 = parseInt(lhm[1]);
  const lhm_3 = parseInt(lhm[2]);
  let ht = lhm_1 + lhm_2 + lhm_3;
  let d = 0.1 * ht;
  let tydb = ht - d;

  document.getElementById("f1").textContent = "Rp " + ht;
  document.getElementById("f2").innerHTML = "Rp " + d;
  document.getElementById("f3").innerHTML = "Rp " + tydb;
}

const lhm = ["10000", "25000", "15000"];
cttl(lhm);
